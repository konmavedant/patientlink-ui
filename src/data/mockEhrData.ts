...
export const mockAuditLogs: Record<string, AuditLogEntry[]> = {
  ...
  'p2': [
    ...
    },
    {
      ...
      recordType: 'lab',
      patientId: 'p2',
      details: 'Added cholesterol panel results'
    }
  ],
  'p3': [
    {
      id: 'log9',
      timestamp: '2023-03-22T15:15:00',
      action: 'create',
      performedBy: {
        id: 'doc3',
        name: 'Dr. Olivia Brown',
      ...
      recordType: 'visit',
      patientId: 'p3',
      details: 'Created annual check-up record'
    }
  ],
  'p4': [
    {
      id: 'log10',
      timestamp: '2023-04-10T12:45:00',
      action: 'create',
      performedBy: {
        id: 'doc4',
        name: 'Dr. Michael Rodriguez',
      ...
      recordType: 'diagnosis',
      patientId: 'p4',
      details: 'Created knee injury assessment record'
    },
    {
      id: 'log11',
      timestamp: '2023-04-17T11:00:00',
      action: 'create',
      performedBy: {
        id: 'doc4',
        name: 'Dr. Michael Rodriguez',
  ...
  'p5': [
    {
      ...
      recordType: 'visit',
      patientId: 'p5',
      details: 'Created dermatology consultation record'
    },
    {
      id: 'log13',
      timestamp: '2023-03-15T14:10:00',
      action: 'create',
      performedBy: {
        id: 'doc5',
        name: 'Dr. Sarah Johnson',
      ...
      recordType: 'prescription',
      patientId: 'p5',
      details: 'Created prescription for dermatitis treatment'
    }
  ],
  'p6': [
    {
      ...
      recordType: 'visit',
      patientId: 'p6',
      details: 'Created gastroenterology consultation record'
    }
  ],
  'p7': [],
  'p8': [],
  ...
  'doc1': [
    {
      ...
      message: 'Jane Doe has granted you access to her medical records',
      type: 'access',
    ...
    },
    {
      ...
      message: 'Lab results for John Smith have been uploaded',
      type: 'update',
    ...
    },
    {
      ...
      message: 'You have an appointment with Jane Doe tomorrow at 9:30 AM',
      type: 'appointment',
      date: '2023-02-14T08:00:00',
      read: false
    }
  ],
  'doc2': [
    ...
    },
    {
      ...
      message: 'Potential drug interaction detected for patient Robert Johnson',
      type: 'alert',
  ...
  'p1': [
    {
      ...
      message: 'Dr. Elizabeth Chen has added a new medical record to your profile',
      type: 'update',
      date: '2023-02-15T10:45:00',
      read: true
    },
    {
      id: 'notif7',
      ...
      message: 'Remember to refill your migraine medication before it runs out',
      type: 'alert',
    ...
    },
    {
      ...
      message: 'You have an appointment with Dr. Elizabeth Chen on May 15th at 10:00 AM',
      type: 'appointment',
